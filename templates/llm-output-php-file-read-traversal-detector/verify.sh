#!/usr/bin/env bash
# verify.sh — worked-example end-to-end check for the PHP
# file-read / path-traversal detector.
set -u
...
KIND_RE=': (php-file-get-contents-tainted|php-readfile-tainted|php-fopen-tainted|php-file-tainted):'
