#!/usr/bin/env bash
# verify.sh — worked-example end-to-end check for the Java
# log-injection (CWE-117) detector.
set -u
...
KIND_RE=': (java-log-injection-concat|java-log-injection-format|java-log-injection-bare-tainted):'
